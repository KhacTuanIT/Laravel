...
@section('MenuBar_AddCustomerMember','m-menu__item m-menu__item--active')
...
@section('titlePage','Đăng ký khách hàng thành viên')
@section('headTitle','Đăng ký khách hàng thành viên')
		...
		$.ajax({
			...
			success: function(data){
				if(data.status == true){
					$('.alert-danger').hide();
					$('.alert-success').show();
					$('.m-alert-success__text').text("Đăng ký thành công");
