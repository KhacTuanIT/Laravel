...
<div class="m-content">
	...
	<div class="m-portlet m-portlet--mobile">
		...
		<div class="m-portlet m-portlet--tab">
			<form class="m-form m-form--fit m-form--label-align-right" method="post" id="frm-add" action="{{route('post-add-blog')}}" enctype="multipart/form-data">
				...
				<div class="m-portlet__body">
					...
					<div class="form-group m-form__group row">
						...
						<div class="col-10">
							<input class="form-control m-input" type="text" name="title_blog" value="{{old('title_blog')}}" id="example-text-input">
					...
					<div class="form-group m-form__group row">
						...
						<div class="col-10">
							<textarea name="description_blog" class="form-control" data-provide="markdown" rows="10"></textarea>
						</div>
					</div>
					<div class="form-group m-form__group row">
						<label class="col-2 col-form-label">
						...
						<div class="col-10">
							<textarea name="note_blog" class="form-control" data-provide="markdown" rows="10"></textarea>
						</div>
					</div>
