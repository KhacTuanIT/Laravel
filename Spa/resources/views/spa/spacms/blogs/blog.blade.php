			...
			<div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
				<div class="row align-items-center">
					...
					<div class="col-xl-4 order-1 order-xl-2 m--align-right">
						<a href="{{route('get-add-blog')}}" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
							<span>
					...
					<tr>
						...
						<td data-field="Actions" class="m-datatable__cell">
							<span style="overflow: visible; width: 110px;" >
								<a href="{{route('get-edit-blog',$blog->id)}}" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="Edit details">
									<i class="la la-edit"></i>
								</a>
								<button data-url="{{route('get-delete-blog',$blog->id)}}" data-t="{{$blog->title}}" class="b-d delete-gallery m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill" data-toggle="modal" data-target="#modal_delete" title="Delete">
			...
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title">
						Bạn thực sự muốn xoá blog <b id="title-del"></b>
					</h5>
				</div>
				<div class="modal-footer">
					...
					<a class="btn btn-danger" id="del-modal" href="http://">
						Có
					</a>
				</div>
			</div>
