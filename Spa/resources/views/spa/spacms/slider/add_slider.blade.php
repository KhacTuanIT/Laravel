...
<div class="m-content">
	...
	<div class="m-portlet m-portlet--mobile">
		...
		<div class="m-portlet m-portlet--tab">
			<form class="m-form m-form--fit m-form--label-align-right" method="post" id="frm-add" action="{{route('post-add-slider')}}" enctype="multipart/form-data">
				...
				<div class="m-portlet__body">
					<div class="form-group m-form__group row">
						...
						<div class="col-2 custom-file">
							<input type="file" id="file2" name="image_slider" accept="image/*" class="custom-file-input" style="opacity: 1; height: 2rem;">
						</div>
					</div>
