...
<div class="m-content">
	...
	<div class="m-portlet m-portlet--mobile">
		...
		<div class="m-portlet m-portlet--tab">
			<form class="m-form m-form--fit m-form--label-align-right" method="post" id="frm-add" action="{{route('add-gallery')}}" enctype="multipart/form-data">
				...
				<div class="m-portlet__body">
					...
					<div class="form-group m-form__group row">
						...
						<div class="col-10">
							<input class="form-control m-input" type="text" name="title_gallery" value="" id="example-text-input">
					...
					<div class="form-group m-form__group row">
						...
						<div class="col-10">
							<textarea name="description_gallery" class="form-control" data-provide="markdown" rows="10"></textarea>
						</div>
					</div>
					<div class="form-group m-form__group row">
						...
						<div class="col-10">
							<select class="form-control m-input" name="type_gallery" id="exampleSelect1">
					...
					<div class="form-group m-form__group row">
						...
						<div class="m-radio-inline col-10">
							<label class="m-radio">
								<input type="radio" name="type_s" value="massage" checked>
								Massage
								<span></span>
							</label>
							<label class="m-radio">
								<input type="radio" name="type_s" value="markup">
								Markup
								<span></span>
							</label>
							<label class="m-radio">
								<input type="radio" name="type_s" value="beautiful">
								Beautiful
								<span></span>
							</label>
						</div>
					...
					<div class="form-group m-form__group row">
						...
						<div class="col-2 custom-file">
							<input type="file" id="file2" name="image_gallery" accept="image/*" class="custom-file-input" style="opacity: 1; height: 2rem;">
...
<script>
	$(document).ready(function() {
		...
		// $('#add').click(function() {
		// 	if($('input[name="title_gallery"]').val() == "") {
		// 		$('#title-error').text('Bạn chưa nhập tiêu đề.');
		// 	}
		// 	if($('input[name="image_gallery"]').val() == "") {
		// 		$('#image-error').text('Bạn chưa chọn ảnh.');
		// 	}
		// 	if($('input[name="type_gallery"]').val() == "") {
		// 		$('#type-error').text('Bạn chưa chọn dịch vụ.');
		// 	}
		// });
