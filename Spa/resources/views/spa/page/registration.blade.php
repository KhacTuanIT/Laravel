	...
	<div class="container login">
		<div class="login-form">
		    ...
		    <form method="post">
		    	...
		    	<input type="radio" name="gender" required="required" checked /> <label>Male</label>
		    	<input type="radio" name="gender" required="required" /> <label>Female</label> <br/>
		        <input type="password" name="p" placeholder="Password" required="required" />
		        <a type="submit" class="btn btn-primary btn-block btn-large">Sign up</a>
		    </form>
		</div>
	</div>
</div>
